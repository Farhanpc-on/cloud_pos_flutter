...
// Remove the import for the removed package
...
class _NewVisitFormState extends State<NewVisitForm> {
  ...
  // Keep the initialization of visitOn
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      // Removed the Column containing the DateTimePicker
                      // Column(
                      //   crossAxisAlignment: CrossAxisAlignment.start,
                      //   children: [
                      //     Text(
                            ...
                            if (await Helper().checkConnectivity()) {
                              if (_formKey.currentState!.validate() &&
                                ...
                                Map visitDetails = {
                                  ...
                                  // Keep the visit_on field, using the initialized value
                                  'visit_on': visitOn,
