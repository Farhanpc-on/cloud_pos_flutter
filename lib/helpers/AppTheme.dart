...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      iconTheme: IconThemeData(color: Color(0xff495057), size: 24), toolbarTextStyle: lightAppBarTextTheme.bodyMedium, titleTextStyle: lightAppBarTextTheme.headlineSmall,
    ),
    ...
    sliderTheme: SliderThemeData(
      ...
      valueIndicatorTextStyle: TextStyle(
        color: Colors.white,
            ...
            // Removed secondaryVariant
            onSecondary: Colors.white,
            surface: Color(0xffe2e7f1),
            onSurface: Color(0xff495057),
            error: Color(0xfff0323c)
            )
        .copyWith(secondary: Color(0xff3d63ff)).copyWith(surface: Colors.white),
  );
  static ThemeData darkTheme = ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: IconThemeData(color: Color(0xffffffff), size: 24), toolbarTextStyle: darkAppBarTextTheme.bodyMedium, titleTextStyle: darkAppBarTextTheme.headlineSmall,
      ),
      cardTheme: CardThemeData(
      ...
      cupertinoOverrideTheme: CupertinoThemeData(), colorScheme: ColorScheme.dark(
        ...
        error: Colors.orange
      ).copyWith(secondary: Color(0xff3d63ff)).copyWith(surface: Color(0xff464c52)));
